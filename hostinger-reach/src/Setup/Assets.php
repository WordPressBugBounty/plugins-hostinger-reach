...
class Assets {
    ...
    private function get_translations(): array {
        return array(
            ...
            'hostinger_reach_confirm_sync_modal_title'                => __( 'Sync contacts', 'hostinger-reach' ),
            'hostinger_reach_confirm_sync_modal_text'                 => __( 'Would you like to sync contacts collected while sync was disabled?', 'hostinger-reach' ),
